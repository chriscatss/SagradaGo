const exportToCSV = (data, filename) => {
    ...
    const formatData = {
      ...
      document_tbl: (doc) => [
        doc.id,
        doc.document_firstname,
        doc.document_middle || '',
        doc.document_lastname,
        doc.document_gender,
        new Date(doc.document_bday).toLocaleDateString(),
        doc.document_mobile || '',
        doc.document_status || '',
        doc.document_baptismal || '',
        doc.document_confirmation || '',
        doc.document_wedding || ''
      ],
