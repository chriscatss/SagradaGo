...
const formatDisplayValue = (field, toDisplayValue) => {
    ...
    if (field === 'booking_status') {
    ...
    } else if (field === 'admin_mobile' || field === 'user_mobile' || field === 'document_mobile') {
        return (
            <div className="flex items-center text-gray-700">
        ...
        field === 'document_baptismal' ||
        field === 'document_confirmation' ||
        field === 'document_wedding' ||
        field === 'paid') {
        let displayValue = '';
