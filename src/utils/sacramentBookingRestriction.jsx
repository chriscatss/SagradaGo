const restrictSacramentBooking = (selectedSacrament, date) => {
    ...
    } else if (selectedSacrament === 'Wedding' && date < new Date(Date.now() + 6 * 30 * 24 * 60 * 60 * 1000)) {
        return 'Wedding bookings must be at least 6 months in advance.';
    ...
    } else if (selectedSacrament === 'Anointing of the Sick' && date < new Date(Date.now() + 2 * 30 * 24 * 60 * 60 * 1000)) {
        return 'Anointing of the Sick bookings must be at least 2 days in advance.';
    }
    return '';
}
